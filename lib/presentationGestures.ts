...
> = {
  ...
  wave: { animationId: "seg_055", layer: "upper_body" },
  goodbye: { animationId: "seg_009", layer: "upper_body" },
  walk: { animationId: "seg_499", layer: "upper_body" },
  talk: { animationId: "seg_377", layer: "upper_body" },
  point: { animationId: "seg_369", layer: "upper_body" },
  ...
  confused: { animationId: "seg_404", layer: "upper_body" },
...
export function estimateSpeechSeconds(text: string): number {
  ...
  // Intentionally conservative: animation may be prepared beyond the audio
  // end, but playback is still stopped by the real TTS completion event.
